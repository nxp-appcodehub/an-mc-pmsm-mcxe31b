...
define. */
#if defined(RAM_RELOCATION) && RAM_RELOCATION==1                           /* All functions will be stored in variable memories*/
    #define RAM_FUNC_LIB		__attribute__((section(".ramfunc.$ITCM")))	/* function executed from ITCM */
