...
__attribute__((section(".bss.$DTCM")))
#endif
...
static void M1_StateInitFast(void)
{
    ...
    //g_sM1Drive.sPosition.sSpeedPiParams.fltUpperLim = 3.0f;//M1_SERVO_SPEED_PI_HIGH_LIMIT;
    //g_sM1Drive.sPosition.sSpeedPiParams.fltLowerLim = -3.0f;//M1_SERVO_SPEED_PI_LOW_LIMIT;
